...
{
    class PDMLInputHandler : InputHandler
    {
        ...
        public override String XMLFilePath
        {
            get
            {
                if (String.IsNullOrEmpty(XMLPath))
                {
                    ...
                    if ((null != oPDMLInput.OptionalXSLT) && (null != oPDMLInput.OptionalXSLT.PDML2XML))
                    {
        ...
        public override XmlSchemaSet SchemaSet
        {
            get
            {
                if (null == SchemaPaths)
                {
                    ...
                    // Get the path and file name of the PDML2XML XSLT file
                    if ((null != oPDMLInput.OptionalXSLT) && (null != oPDMLInput.OptionalXSLT.PDML2XSD))
                    {
