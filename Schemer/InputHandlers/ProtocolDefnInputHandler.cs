...
{
    class ProtocolDefnInputHandler : Convert2XMLInput
    {
        ...
        private ProtocolDefinition InitialiseProtocolDefn(String ProtocolDefnXML)
        {
            ...
            Assemblies[0] = Assembly.GetAssembly(typeof(Fuzzware.Convert2XML.C2X.Convert2XML));         // Convert2XML
            Assemblies[1] = Assembly.GetAssembly(typeof(Fuzzware.Evaluate.EvaluationFunctions));    // Evaluate & ProtoclDefn
