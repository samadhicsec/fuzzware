...
{
    public class OutputHandlersFactory
    {
        static public OutputHandler GetOutputHandler(EvaluationMethod oOutputFn)
        {
            ...
            else if (oOutputFn.Item is OutputToWebService)
                return new OutputToWebServiceHandler();
            else if (oOutputFn.Item is OutputToCOM)
                return new OutputToCOMHandler();
